...
#+LATEX: \begin{bclogo}[logo=\checkmark, couleurBarre=blue, noborder=true, couleur=blue!10]{}
Aim for the smallest possible break that allows for fluid flow from the glass filament in order to minimize the damage to the HIO during microinjection.
#+LATEX: \end{bclogo}
